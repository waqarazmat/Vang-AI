  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1200px] px-[40px] pb-[88px]">
        <RevealGroup className="grid grid-cols-[repeat(auto-fit,minmax(min(300px,100%),1fr))] gap-[20px]">
          <RevealItem className="min-w-0 rounded-[26px] bg-ink p-[40px] text-cream">
          ...
          <RevealItem className="min-w-0 rounded-[26px] border border-ink/12 bg-paper p-[40px]">
  ...
  return (
    <section className="border-y border-ink/12 bg-sand">
      <div className="mx-auto max-w-[1200px] px-[40px] py-[88px]">
        ...
        <RevealGroup className="mt-[34px] grid grid-cols-[repeat(auto-fit,minmax(min(210px,100%),1fr))] gap-[14px]">
          {items.map((item, i) => (
            <RevealItem
              key={item.title}
              className="card-lift flex min-w-0 flex-col gap-[10px] rounded-[20px] border border-ink/12 bg-cream p-[24px]"
            >
...
export function AboutContact() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-[40px] pt-[88px]">
      <Reveal className="grid grid-cols-[repeat(auto-fit,minmax(min(300px,100%),1fr))] items-center gap-x-[56px] gap-y-[24px] border-y border-ink/18 py-[48px]">
